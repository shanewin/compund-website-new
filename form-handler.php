...
// ✅ Send email using native PHP mail() - TEST EMAIL
$to = 'shanewin@gmail.com'; // Test email address
$subject = 'TEST: New Wait List Submission - The Compound';
$headers = "From: waitlist@thecompound.nyc\r\n";
$headers .= "Reply-To: $email\r\n";
$headers .= "Content-Type: text/plain; charset=UTF-8\r\n";

$body = <<<EOD
New Wait List Inquiry for The Compound:
